...
#Carte du nombre d'accidents par départements

################################################################################################

install.packages(c("leaflet", "dplyr", "maps"))
library(leaflet)
library(maps)
library(dplyr)
...
#Carte du nombre d'accidents par régions
...
#Carte du taux d'accidents graves par départements
...
#Carte du taux d'accidents graves par régions
